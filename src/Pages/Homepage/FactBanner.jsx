  ...
  return (
    <div className=" mt-5">
      <div className=" flex items-center justify-center">
        <div className="h-[860px] w-[94%] lg:h-[600px] lg:w-[906px] bg-black rounded-3xl flex lg:gap-20 items-center mb-12 p-5 flex-col lg:flex-row-reverse justify-between">
          <div className="fact h-[500px] w-full lg:h-full md:w-1/2 mt-3 rounded-3xl flex items-center justify-center">
